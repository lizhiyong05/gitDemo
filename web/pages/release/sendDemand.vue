<template>
	<!-- 发布需求 -->
	<view>
		<headerComponent headerTitle="发需求" headerStyle="border-bottom: 1px solid #e5e5e5"></headerComponent>
		<section class="section-padding-top-138">
			<h2 class="title">添加需求信息</h2>
			<view class="block">
				<p class="second-title">需求标题</p>
			...
			<view class="info">
				<p class="info-title">需求简介</p>
				<textarea maxlength="200" cursor-spacing="50" :auto-height="true" placeholder="请输入招募简介" placeholder-class="textarea-class"></textarea>
			</view>
